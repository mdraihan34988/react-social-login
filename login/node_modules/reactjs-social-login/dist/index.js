...
var _window = window;
var LoginSocialAmazon = React.memo(function (_ref) {
  ...
  var checkIsExistsSDKScript = React.useCallback(function () {
    return !!document.getElementById(SCRIPT_ID);
  }, []);
  var insertScriptGoogle = React.useCallback(function (d, s, id, jsSrc, cb) {
    if (s === void 0) {
      s = 'script';
    }
  ...
  var handleResponse = React.useCallback(function (res) {
...
var LoginSocialFacebook = React.memo(function (_ref) {
  ...
  var insertSDKScript = React.useCallback(function (document, cb) {
  ...
  var initFbSDK = React.useCallback(function (config, document) {
    var _window = window;
  ...
  var getMe = React.useCallback(function (authResponse) {
    _window$1.FB.api('/me', {
      locale: language,
  ...
  var handleResponse = React.useCallback(function (response) {
  ...
  var loginFB = React.useCallback(function () {
    if (isProcessing || !isSdkLoaded) return;
    setIsProcessing(true);
...
var LoginSocialGoogle = React.memo(function (_ref) {
  ...
  var loginGoogle = React.useCallback(function () {
    if (isProcessing || !isSdkLoaded) return;
    setIsProcessing(true);
...
var LoginSocialGithub = React.memo(function (_ref) {
  var _ref$state = _ref.state,
      state = _ref$state === void 0 ? 'DCEeFWf45A53sdfKef424' : _ref$state,
      _ref$scope = _ref.scope,
  ...
  var onChangeLocalStorage = React.useCallback(function () {
  ...
  var getAccessToken = React.useCallback(function (code) {
    setIsProcessing(false);
    onResolve({
      provider: 'github',
      data: {
  ...
  var handlePostMessage = React.useCallback(function (_ref2) {
    var type = _ref2.type,
        code = _ref2.code,
...
var LoginSocialInstagram = React.memo(function (_ref) {
  var _ref$state = _ref.state,
      state = _ref$state === void 0 ? 'DCEeFWf45A53sdfKef424' : _ref$state,
      client_id = _ref.client_id,
      className = _ref.className,
...
var LoginSocialMicrosoft = React.memo(function (_ref) {
  ...
  var getProfile = React.useCallback(function (data) {
...
var LoginSocialLinkedin = React.memo(function (_ref) {
  var _ref$state = _ref.state,
      state = _ref$state === void 0 ? 'DCEeFWf45A53sdfKef424' : _ref$state,
      _ref$scope = _ref.scope,
...
exports.LoginSocialAmazon = LoginSocialAmazon;
exports.LoginSocialFacebook = LoginSocialFacebook;
exports.LoginSocialGithub = LoginSocialGithub;
exports.LoginSocialGoogle = LoginSocialGoogle;
exports.LoginSocialInstagram = LoginSocialInstagram;
exports.LoginSocialLinkedin = LoginSocialLinkedin;
exports.LoginSocialMicrosoft = LoginSocialMicrosoft;
